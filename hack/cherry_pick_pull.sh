...
# Usage Instructions: https://github.com/zach593/karmada/blob/master/docs/contributors/devel/cherry-picks.md
...
if [[ "$#" -lt 2 ]]; then
  ...
  echo
  echo "  For merge process info, see https://github.com/zach593/karmada/blob/master/docs/contributors/devel/cherry-picks.md"
  exit 2
fi
...
${numandtitle}
For details on the cherry pick process, see the [cherry pick requests](https://github.com/zach593/karmada/blob/master/docs/contributors/devel/cherry-picks.md) page.
\`\`\`release-note
\`\`\`
EOF
  )
